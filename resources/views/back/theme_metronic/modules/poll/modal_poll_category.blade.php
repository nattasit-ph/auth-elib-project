<!-- Modal-->
<div class="modal fade" id="modal_category" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="modal_poll_category_label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-pri" id="modal_poll_category_label">สร้างหมวดหมู่ใหม่</h5>
...
function saveCategory() 
{
	$.ajax({
		...
		url: "{{ route('admin.poll.category.quickSave') }}",
		type: 'POST',
		data: { 
