...
<a href="{{ route('admin.poll.category.create') }}" class="btn btn-brand btn-bold">
...
<div id="main_content" class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<!--begin::Portlet-->
	<input type="hidden" class="form-control" id="page_url_set_status" value="{{ route('admin.poll.category.setStatus') }}">
	<input type="hidden" class="form-control" id="page_url_delete" value="{{ route('admin.poll.category.delete') }}">
	<!--end::Portlet-->
</div>
@endsection
...
function initDataTable() {
	...
	$('#main-table').DataTable({
	     ...
	     pageLength: 25,
	     ajax: {
            "url": "{{ route('admin.poll.category.datatable') }}",
            "type": "POST",
