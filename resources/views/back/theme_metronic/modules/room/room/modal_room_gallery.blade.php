<div id="modal_room_gallery" class="modal fade bd-example-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form id="frm_modal_room_gallery" name="frm_modal_room_gallery" method="POST" enctype="multipart/form-data">
      @csrf
      @method('POST')
        <input type="hidden" id="modal_room_id" name="modal_room_id" value="{{ $content->id ?? '' }}">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                  ...
                  <input type="file" name="modal_room_gallery_file" class="form-control required"/>
                  <div class="my-3">
          ...
          <div class="modal-footer">
              <div class="d-flex justify-content-between">
                  <button id="btn_room_gallery_submit" type="button" class="btn btn-primary text-uppercase mr-2"><i class="la la-upload"></i> Upload</button>
