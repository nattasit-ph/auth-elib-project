...
<a href="{{ route('admin.reward-category.index', $org_slug) }}" class="btn btn-label-brand btn-bold">
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	<div class="kt-portlet">
		<div class="kt-portlet__head">
			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-form__actions">
					 ...
					 <?php } ?>
					 <a href="{{ route('admin.reward-category.index', $org_slug) }}" class="ml-1 btn btn-secondary btn-bold btn-wide kt-font-transform-u">Cancel</a>
				</div>
			</div>
		</div>
		<div class="kt-portlet__body kt-portlet__body--fit">
			...
			<form id="frm_main" class="kt-form" action="{{ ($reward_category ?? '') ? route('admin.reward-category.update', [$org_slug, $reward_category->id]) : route('admin.reward-category.store', $org_slug) }}" method="POST">
				@csrf
				@method('POST')
				...
				<div class="kt-portlet__body">
					<div class="kt-section mb-0">
						...
						<div class="form-group">
							...
							<input id="slug" name="slug" type="text" class="form-control" placeholder="Enter pretty URL" value="{{ $reward_category->slug ?? old('slug') }}" autocomplete="off">
