...
@section('title', __('menu.back.privacy_policy'))
@section('page_title', __('menu.back.privacy_policy'))
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	<div class="kt-portlet">
		<div class="kt-portlet__head">
			<div class="kt-portlet__head-label">
				<h3 id="section_title" class="kt-portlet__head-title">
					{{ $page_header ?? 'Edit privacy policy'}}
				</h3>
			</div>
		...
		<div class="kt-portlet__body kt-portlet__body--fit">
			...
			<form id="frm_main" class="kt-form" action="{{ route('admin.site.updatePrivacyPolicy') }}" method="POST" enctype="multipart/form-data">
				@csrf
				@method('PUT')
