...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<div class="kt-portlet">
		...
		<div class="kt-portlet__body kt-portlet__body--fit">
			...
			<form id="frm_main" class="kt-form" action="{{ route('admin.site.consent.save') }}" method="POST" enctype="multipart/form-data">
				@csrf
						...
						<div class="kt-section mb-0">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="number" class="form-control re_consent" name="re_consent" value="6">
							...
							<div class="form-group">
								...
								<div class="form-group">
									<textarea class="summernote summernote-desc detail_en" name="detail_en"></textarea>
								</div>
							</div>
							<div class="form-group">
								<label>เนื้อหา (ภาษาไทย) :</label>
								<div class="form-group">
									<textarea class="summernote summernote-desc detail_th" name="detail_th"></textarea>
								</div>
							</div>
						</div>
					</div>
