	...
	<div class="kt-portlet">
		...
		<div class="kt-portlet__body kt-portlet__body--fit">
			...
			<form id="frm_main" class="kt-form" action="{{ route('admin.site.savePolicyAndTerms', $org_slug) }}" method="POST" enctype="multipart/form-data">
				@csrf
				<input type="hidden" name="check_type" value="3">

				<div class="kt-portlet__body font-pri hr-content">
					<div class="row p-3 d-flex align-items-center">
						<div class="col-md-12">
							<p class="f-content">Content (in English)</p>
							<textarea class="summernote" name="detail_en">{{ $cookie->detail_en ?? ''; }}</textarea>
						</div>
					</div>
				</div>
				<div class="kt-portlet__body font-pri hr-content">
					<div class="row p-3 d-flex align-items-center">
						<div class="col-md-12">
							...
							<textarea class="summernote" name="detail_th">{{ $cookie->detail_th ?? ''; }}</textarea>
						</div>
					</div>
				</div>
