...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	<div class="kt-portlet">
		<div class="kt-portlet__head">
			<div class="kt-portlet__head-label">
				<h3 id="section_title" class="kt-portlet__head-title">
					{{ $page_header ?? 'Edit Google Analytics'}}
				</h3>
			</div>
		...
		<div class="kt-portlet__body kt-portlet__body--fit">
			...
			<form id="frm_main" class="kt-form" action="{{ route('admin.site.updateGoogleAnalytics', $org_slug) }}" method="POST" enctype="multipart/form-data">
				@csrf
				@method('PUT')
				...
				<div class="kt-portlet__body">
					<div class="kt-section mb-0">
						...
						<div class="form-group">
							...
							<div>
								<label>Link: https://www.googletagmanager.com/gtag/js?id=<u>UA-74443868-1</u></label>
							</div>
							<div>
								<label>Value: UA-74443868-1</label>
							</div>
