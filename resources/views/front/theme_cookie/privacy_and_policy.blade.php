        ...
        <div class="mt-5 position-relative overflow-hidden" style="height: 80%; padding-top: 30px;">
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <h3 class="pt-5 text-center">{{__('common.common_privacy')}}</h3>
                    <?php 
                    ...
                    ?>
                    <br>
                    <a href="<?php echo route('policy-download')?>" class="text-success " target="_blank" style="font-weight: bold;">
                        {{__('common.common_use_download_policy')}}
                    </a>
                </div>
            </div>
        </div>
