...
return [
    ...
    'identifiers' => [
        ...
        */
        ...
        'ldap' => [
            ...
            'locate_users_by' => config('bookdose.ldap.locate_users_by'),
    ...
    */
    ...
    'sync_attributes' => [
        ...
        'username' => env('LDAP_SYNC_USERNAME', 'samaccountname'),
        'email' => env('LDAP_SYNC_EMAIL', 'userprincipalname'),
        'name' => env('LDAP_SYNC_NAME', 'cn'),
        // 'display_name' => env('LDAP_SYNC_DISPLAY_NAME', 'cn'),
